...
import {Icon, Input, Radio, Tooltip, Button} from 'antd'
...
class CategoryFeedbackLabel extends React.Component {
  constructor(props) {
    super(props);
        ...
        {getFieldDecorator(`feedbackType[${k}]`,
          ...
          <RadioGroup onChange={this.radioChange} name={k.toString()}>
            ...
            <Radio value="Radio">
              <span>
                Multiple Choice&nbsp;
                <Tooltip title="Multiple choices">
                  <Icon type="question-circle-o"/>
                </Tooltip>
              </span>
            </Radio>
        ...
        <FormItem
            ...
            <FormItem {...formItemLayoutWithOutLabel}>
              <Button type="dashed" onClick={() => {addExample(k, 'feedbackradio')}} style={{width: '90%'}}>
                <Icon type="plus"/> Add Radio option
              </Button>
            </FormItem>
            </div> : null}
  ...
  showExample (examples, indexQuestion, exampleType) {
    ...
    if (exampleType === "example"){
      placeholder = "I had no issues or questions about any of the sentences/labels."
    }
...
export default CategoryFeedbackLabel
