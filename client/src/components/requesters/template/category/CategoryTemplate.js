                ...
                <Tabs defaultActiveKey="preview">
                    <TabPane tab={<span>Preview</span>} key="preview">
                        <div> 
                            ...
                            {this.state.showlink ? 
                                <p>Please go to https://cmu-dialcrowd.herokuapp.com/worker_category?MID={this.state.username}ID={this.props.thisstate._id} in a separate window to complete the HIT</p>
                                : null}
                            ...
                            &lt;div&gt; <br></br>
                                ...
                                <p style={{"margin-left": "20px"}}>&lt;script&gt;</p>
                                    <p style={{"margin-left": "40px"}}>document.getElementById('submit').onclick = function(event) {"{"}</p>
                                        ...
                                        <p style={{"margin-left": "60px"}}>document.getElementById("dialcrowd_link").textContent = "Please go to https://cmu-dialcrowd.herokuapp.com/worker_category/?ID=5f0b6fe49878971ce8ab83c9&MID=" + document.getElementById("workerid").value + " in a separate window to complete the HIT"</p>
