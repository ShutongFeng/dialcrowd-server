                ...
                <Tabs defaultActiveKey="preview">
                    <TabPane tab={<span>Preview</span>} key="preview">
                        <div> 
                            ...
                            {this.state.showlink ? 
                                <p>Please go to https://cmu-dialcrowd.herokuapp.com/worker_interactive?MID={this.state.username}&ID={this.props.thisstate._id} in a separate window to complete the HIT</p>
                                : null}
                            <br></br>
