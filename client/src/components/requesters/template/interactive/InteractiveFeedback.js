...
class InteractiveFeedback extends React.Component {
  ...
  render() {
    ...
    return <div>
      ...
      <h1>Feedback </h1>
      <Table rowKey="userId" dataSource={this.state.feedbacks} columns={feedback_detail_col} size="small" />
    </div>
  }
}
...
export default connect(mapStateToProps, mapDispatchToProps)(InteractiveFeedback);
